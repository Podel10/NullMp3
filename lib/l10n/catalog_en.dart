const catalogEn = <String, String>{
  ...
  'downloadAudioBadLink': 'Need a SoundCloud link.',
  'downloadAudioFailed': 'Could not download this link',
  'downloadAudioCancelled': 'Cancelled',
  'downloadAudioSaved': 'Saved {n} to the library',
  'downloadAudioItem': '{index} / {total}  {title}',
  'downloadAudioFolder': 'Saved to Music/NullMP3',
